...
\textbf{JoanaVertex} und \textbf{JoanaEdge} beinhalten Attribute, wie zum Beispiel Kanten- und Knotenart.\\
\textbf{Callgraph} und \textbf{Methodengraph}(en) werden in dem \textbf{JoanaGraphModel} gespeichert.