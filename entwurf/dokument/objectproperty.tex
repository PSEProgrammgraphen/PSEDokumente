...
\begin{itemize}
\item{\vskip -.9ex 
A string with whoom, factories or other elements from the GUI, can reference to the value. String über den von der GUI aus, Factories oder Änliches, auf den Value verwiesen werden kann.}
\end{itemize}
}
\item{
\index{valueAsString}
