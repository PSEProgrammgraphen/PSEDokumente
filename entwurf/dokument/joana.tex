...
\entityintro{CallGraphLayout}{joana.CallGraphLayout}{Offers a layout for \texttt{\small CallGraph}{\small 
\refdefined{joana.CallGraph}}.}
...
{\bf  collapse}\\
\begin{lstlisting}[frame=none]
public graphmodel.CompoundVertex collapse(java.util.Set subset)\end{lstlisting} %end signature
}%end item
\item{ 
\index{expand(CompoundVertex)}
{\bf  expand}\\
\begin{lstlisting}[frame=none]
public java.util.Set expand(graphmodel.CompoundVertex vertex)\end{lstlisting} %end signature
}%end item
\item{ 
...
{\bf  isCompound}\\
\begin{lstlisting}[frame=none]
public boolean isCompound(graphmodel.Vertex vertex)\end{lstlisting} %end signature
}%end item
\end{itemize}
}
}
...
\vskip .1in 
Offers a layout for \texttt{\small CallGraph}{\small 
\refdefined{joana.CallGraph}}. Groups vertices representing the same Java-Method together.\vskip .1in 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
Returns a list of all \texttt{\small FieldAccess}{\small 
\refdefined{joana.FieldAccess}} in the MethodGraph.
}
\item{{\bf  Returns} -- 
A list of all \texttt{\small FieldAccess}{\small 
\refdefined{joana.FieldAccess}} in the MethodGraph. 
}%end item
\end{itemize}
}%end item
...
Returns a list of all \texttt{\small JoanaVertex}{\small 
\refdefined{joana.JoanaVertex}} which are method calls in the MethodGraph.
}
\item{{\bf  Returns} -- 
A list of all method calls. 
}%end item
\end{itemize}
}%end item
\item{ 
