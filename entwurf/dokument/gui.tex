...
\begin{itemize}
\item{ 
\index{EdgeShape(Edge)}
{\bf  EdgeShape}\\
\begin{lstlisting}[frame=none]
public EdgeShape(graphmodel.Edge edge)\end{lstlisting} %end signature
\begin{itemize}
\item{
{\bf  Description}
...
{\bf  Parameters}
  \begin{itemize}
   \item{
\texttt{edge} -- The Edge that supplies the information for building an EdgeShape.}
  \end{itemize}
}%end item
\end{itemize}
}%end item
