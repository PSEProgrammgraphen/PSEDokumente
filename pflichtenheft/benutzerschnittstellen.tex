...
\begin{tabular}{lp{0.75\linewidth}}
  ...
  -ws <typeid> & Legt den Typ des Graphen fest. Über den Typ des Graphen wird das Import-Plugin, sowie initiale Darstellungsoptionen festgelegt. Arbeitsbereiche können von Plugins definiert werden. (siehe \autoref{ch:plugschnitt})
\end{tabular}
