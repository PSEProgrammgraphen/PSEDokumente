...
\begin{tabular}{llp{0.9\linewidth}}
	\subtest
		...
		{Den Menüeintrag ''File->Import'' auswählen.}
...
\begin{tabular}{llp{0.9\linewidth}}
	\subtest
		...
		{Doppelklick auf einen Knoten des \glspl{callgraph} in der \hyperref[gui:strukturansicht]{Strukturansicht}.}
	...
	\subtest
		...
		{Den Menüeintrag ''Open'' auswählen.}
...
\end{tabular}
\\ \\ \\
\test{constraint}{Gruppe erstellen}
\begin{tabular}{llp{0.9\linewidth}}
	\subtest
	...
	\subtest
		...
		{Den Menüeintrag zu ''add to group'' auswählen.}
...
\begin{tabular}{llp{0.9\linewidth}}
	\subtest
		...
		{Den Menüeintrag ''Edit->Filter'' auswählen.}
...
\begin{tabular}{llp{0.9\linewidth}}
	\subtest
		{Ein JOANA-Graph wurde importiert und einer der enthaltenen \glspl{methgraph} oder \gls{callgraph} wird angezeigt (siehe Test \ref{test:importJOANA}, \ref{test:openmethod}).}
		{Den Menüeintrag ''File->Export->\gls{svg}'' auswählen.}
		{Es öffnet sich ein Dateiauswahldialog.}
	\subtest
		{Der Dateiauswahldialog ist geöffnet.}
		{Einen Pfad und den Namen ''testSVG'' angeben. Button zum Exportieren drücken.}
		{Der Dateiauswahldialog wird geschlossen, die \gls{svg}-Datei mit dem angegebenen Namen wurde am ausgewählten Ort erstellt. Sie enthält die visuelle Repräsentation des gesamten Graphen, wie er in der \hyperref[gui:graphansicht]{Graphansicht} dargestellt wurde.}
\end{tabular}
