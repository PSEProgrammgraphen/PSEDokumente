...
\begin{tabular}{llp{0.9\linewidth}}
	...
	\subtest
		...
		{In der Tableiste (siehe \ref{gui:tableiste}) wird der ursprüngliche \gls{callgraph} aus Schritt 1. ausgewählt.}
...
\begin{tabular}{llp{0.9\linewidth}}
	\subtest
		{Ein JOANA-Graph wurde importiert und einer der enthaltenen \glspl{methgraph} oder \gls{callgraph} wird angezeigt (siehe Test \ref{test:importJOANA}, \ref{test:openmethod}). Der Mauszeiger befindet sich in der Graphansicht.}
		{Halten der Strg-Taste und Mausrad von sich weg schieben.}
		{Das vorherige Sichtfeld wurde, in Richtung der Position des Mauszeigers, herangezoomt.}
	\subtest
		{Der angezeigte Graph wird leicht herangezoomt dargestellt.}
		{Mittlere Maustaste in einem leeren Bereich der Graphansicht drücken, die Taste gedrückt halten und ziehen des Mauszeigers.}
	...
	\subtest
		{Der Graph wird in der Graphansicht angezeigt.}
