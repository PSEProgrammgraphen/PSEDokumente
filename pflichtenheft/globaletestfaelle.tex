...
\begin{tabular}{llp{0.9\linewidth}}
	\subtest{Ein JOANA-Graph wurde importiert und einer der enthaltenen Methoden- oder Callgraphen wird angezeigt.}{Selektieren eines Subgraphen durch ziehen oder einzelnes Selektieren.}{Unter der Strukturansicht werden die Informationen zu den selektierten Knoten und Kanten angezeigt.}
\end{tabular}
\\ \\ \\
