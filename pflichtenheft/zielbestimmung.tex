...
\subsection{Graph von Ansicht (Graphviewer)}
  \begin{itemize}
    ...
    \item Eine Übersicht des angezeigten Graphen. Diese Übersicht besteht aus einem Bild des kompletten Graphen und zeigt an in welchem Teil des Graphen das aktuelle \ref{sichtfeld} liegt.  %TODO: zugehörige FA  Jonas F.
