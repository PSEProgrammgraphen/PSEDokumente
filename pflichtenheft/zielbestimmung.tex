...
\subsection{Graph von Ansicht (Graphviewer)}
  \begin{itemize}
    \item Das Produkt ist kein Graph Editor und unterstützt deshalb nicht die Manipulation des Graphen nicht.
    ...
    \item Das Darstellen von Kanten und Knoten mit primitiven geometrischen Objekten wird mithilfe von Bibliotheken umgesetzt. %TODO: Referenz zu benutzten Bibliotheken
...
\subsection{Plugins}
  \begin{itemize}
    ...
    \item Neue Plugins können nicht zur Laufzeit hinzugefügt werden, sondern müssen beim Programmstart vorhanden um genutzt werden können.
  \end{itemize}
