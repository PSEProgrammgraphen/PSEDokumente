...
\begin{itemize}
  ...
  \item Als Inputformat für die zu zeichnenden Graphen wird das \gls{graphml}-Format unterstützt.\\
    ...
    \begin{itemize}
      \item Muss-Konstrukte: graph, node, edge, desc, key, data, default % Ist Port ein Musskriterium? Beim ersten Treffen wurde es erwähnt
      \item Kann-Konstrukte: hyperedge, port, endpoint, Hierarchische/Geschachtelte Graphen,  Multi-Graphen
    \end{itemize}
