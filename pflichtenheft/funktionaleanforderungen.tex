...
\textbf{Vorbedingung:} Ein Graph wurde geladen. Ein Layoutalgorithmus wurde ausgewählt.\\
...
\textbf{Vorbedingung:} Ein Graph wurde geladen. Ein Layoutalgorithmus wurde ausgewählt. Ein Constraint wurde hinzugefügt. \\
...
\textbf{Beschreibung:} Für ein spezifisches Constraint können die Parameter, wie die \gls{gruppe} die das Constraint betrifft nach der Erstellung geändert werden.\\
...
\textbf{Beschreibung:} Ein Constraint kann vom Nutzer gelöscht werden.\\
...
\textbf{Beschreibung:} Die automatisierte Selektion von Subgraphen ermöglicht es automatisch Gruppen zu erstellen, die mit einem bestimmtem \gls{pattern} übereinstimmen. Dies kann beispielsweise genutzt werden, um in größeren Graphen schneller Constraints erstellen.\\
...
\textbf{Beschreibung:} Die Funktion zum Testen von Erreichbarkeit von Knoten ermöglicht es Pfade zwischen Knoten zu betrachten oder sie zu einer Gruppe hinzu zu fügen.\\
