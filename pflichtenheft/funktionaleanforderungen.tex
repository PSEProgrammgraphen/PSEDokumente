...
\textbf{Ziel:} Der Nutzer kann Constraints auswählen die auf den \gls{Subgraph} beim \ref{fa:layout} verwendet werden.\\
...
\textbf{Beschreibung: } \\
Der Benutzer legt eine Anzahl von Constraints für einen \gls{Subgraph}en aus die für das layouten verwendet werden (siehe \ref{fa:layout}).
