...
\textbf{Ziel:} Der Nutzer kann Constraints auswählen, die auf den \glspl{subgraph} beim layouten (siehe \ref{fa:layout}) verwendet werden.\\
...
\textbf{Beschreibung: } \\
Der Benutzer legt eine Anzahl von Constraints für einen \glspl{subgraph} aus, die für das layouten verwendet werden sollen (siehe \ref{fa:layout}).
