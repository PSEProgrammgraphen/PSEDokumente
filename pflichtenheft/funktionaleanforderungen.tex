...
\textbf{Ziel:} \gls{methgraph} in \gls{joana}-Graphdateien werden speziell dargestellt.\\
\textbf{Vorbedingung:} -\\
\textbf{Nachbedingung (Erfolg):} Der Methodengraph wurde wie unten beschrieben dargestellt. \\
\textbf{Nachbedingung (Fehlschlag):} -\\
\textbf{Auslösende Ereignisse:} Eine Graphdatei wird als JOANA-Graph importiert.\\
\textbf{Beschreibung:}\\
...
%TODO: Auf Darstellungsfunktion von JOANA Plugin
