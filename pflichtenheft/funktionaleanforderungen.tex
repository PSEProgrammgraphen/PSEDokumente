...
Der Benutzer wählt die Exportfunktion aus der Menüleiste aus oder wählt die Exportfunktion aus dem Kontextmenü (siehe \ref{fa:kontextmenü}) nach einem Rechtsklick auf den Graphen in der Strukturansicht.\\
\textbf{Beschreibung:}\\
...
Die Exportfunktion für einzelen Graphen (siehe \ref{fa:export_img}) ist durch das Kontextmenü erreichbar.
