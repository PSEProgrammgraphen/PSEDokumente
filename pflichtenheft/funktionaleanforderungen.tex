...
\textbf{Beschreibung:}\\
Eine selektierte Menge von Knoten kann zu einer \gls{gruppe} hinzugefügt werden. Diese können dann beispielsweise für die \ref{fa:constraintsettings} verwendet werden.\\
