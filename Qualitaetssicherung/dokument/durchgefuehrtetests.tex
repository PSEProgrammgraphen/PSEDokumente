...
\begin{longtable}{llp{0.8\linewidth}}
	...
	\test{randomSymmetricCollapseTest()}{Kollabiert zufällig oft Knoten in einem MethodenGraph und expandiert diese danach symetrisch. Es wird überprüft ob sich die Struktur verändert hat.}
