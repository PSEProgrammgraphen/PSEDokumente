...
\bug{33}
		...
		{Beim Neu-Layouten der FieldAccesse wurden alle FieldAccesse und alle von ihnen enthaltenen Knoten betrachtet. Damit auch die FieldAccesse, die kollabiert wurden.}
		{FieldAccesse, die nicht vollständig im Graphen enthalten sind, werden ignoriert.}
