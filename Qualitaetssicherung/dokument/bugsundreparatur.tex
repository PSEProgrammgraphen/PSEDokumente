...
\bug{3}
	{Kanten, die von außen in einen FieldAccess hinein oder von einem FieldAccess nach außen gehen, werden nur bis an die Box des FieldAccesses dran gezeichnet.}
	{Nach dem Layouten des ganzen graphen werden die Kanten nicht von außen von der Box nach innen weiter gezeichnet.}
	{Die Kanten innerhalb eines FieldAccesses werden nun komplett neu gezeichnet. Sowohl die alten, als auch die neuen. Nur die Positionen der Knoten bleiben gleich.}
...
\bug{42}
	{Nach einem commit verschwand dieser Fehler und äußerte sich durch die selben Merkmale wie Bug 44, siehe daher 44.}
	{siehe Bug 44}
	{siehe Bug 44}
